          ...
          <div class="card-header bg-transparent">
            <div class="row align-items-center">
              <div class="col">
                ...
                <h2 class="text-white mb-0">ยอดขาย</h2>
              </div>
              <div class="col">
          ...
          <div class="card-header bg-transparent">
            <div class="row align-items-center">
              <div class="col">
                ...
                <h2 class="mb-0">ยอดการสั่งซื้อบน Website</h2>
              </div>
            </div>
          </div>
          <div class="card-body">
      ...
      <div class="col-xl-8 mb-5 mb-xl-0">
        <div class="card shadow">
          <div class="card-header border-0">
            <div class="row align-items-center">
              <div class="col">
                <h3 class="mb-0">ยอดขายของสินค้า</h3>
              </div>
      ...
      <div class="col-xl-4">
        <div class="card shadow">
          <div class="card-header border-0">
            <div class="row align-items-center">
              <div class="col">
                <h3 class="mb-0">Social ยอดการเข้าชม</h3>
              </div>
              <div class="col text-right">
                <a href="#!" class="btn btn-sm btn-primary">See all</a>
              </div>
