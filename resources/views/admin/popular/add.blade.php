            ...
            <div class="col">
                <div class="card shadow">
                    <div class="card-header border-0">
                        <h2 class="mb-0">Add Popular Product (เพิ่มสินค้ายอดนิยม)</h2>
                    </div>
                        ...
                        <table class="table align-items-center table-flush ">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col" class="col-sm-6 text-center">เพิ่มสินค้ายอดนิยม</th>
                                    <th scope="col" class="col-sm-6 "></th>


                                </tr>
                            <tbody>
                                <form action="{{ route('popular.create') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <th scope="row" style="display: block; margin-left: auto; margin-right: auto;">
                                        <img src="{{ asset('admin/Popular_images/no-pictures.png') }}" alt=""
                                            id="showImage"
                                    ...
                                    <th scope="col">
                                        {{-- <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="type_product"
                                                id="exampleFormControlInput1" placeholder="**เช่น เครื่องดื่ม,ขนม**">
                                            @error('type_product')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div> --}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="exampleFormControlSelect1"
                                                ...
                                                @foreach ($products_type as $p_type)
                                                    <option value="{{ $p_type->id_type_product }}">
                                                        {{ $p_type->type_product }}</option>
                                                @endforeach
                                            </select>
                                            @error('type_product')
                                                <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="popular"
                                                id="exampleFormControlInput1" placeholder="**เช่น มาม่า,เลย์**">
                                            @error('popular')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="price"
                                                id="exampleFormControlInput1" placeholder="**เช่น 15.00**">
                                            @error('price')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
